...
//        return (salary > 0.0);
    ...
    public void validateNewPassword(FacesContext context, UIComponent componentToValidate, Object value) {

        // get new password
        String oldPwd = (String) value;
        // get old password
        UIInput newPwdComponent = (UIInput) componentToValidate.findComponent("newpwd");
        String newPwd = (String) newPwdComponent.getLocalValue();

        System.out.println("VALIDATE NEW PASSWORD");
...
//
    ...
    Object newValue) throws ValidatorException {
        ...
        UIInput cnfpwdInput = (UIInput) componentToValidate.findComponent("cnfpwd");
        String cnfPwd = (String) cnfpwdInput.getLocalValue();

        System.out.println("VALIDATE PASSWORD PAIR");
    ...
    public void showEmployeeDetails() {
        System.out.println("SHOW EMPLOYEE DETAIL");
        FacesContext context = FacesContext.getCurrentInstance();
        ExternalContext externalContext = context.getExternalContext();
        ...
        this.empId = employeeId;
        System.out.println("SETTING EMPLOYEE ID: " + this.empId);
        setEmployeeDetailsForChange();
    }
}
